...
import 'package:healthy_me/widgets/Register.dart';
...
Future<Register> createRegister(
  ...
  final http.Response response = await http.post(
    'https://healthy-me.herokuapp.com/user/register',
...
class _SignUpState extends State<SignUp> {
  ...
  Future<Register> _futureSignUp;
  Future<List<Register>> futureRegister;
